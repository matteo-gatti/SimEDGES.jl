...
pname = "EdgesAlgorithms2.png" #"randV_propE05.png" #"randV_randE.png"
...
for algo in algorithms
    ...
    ndata = [elem / nhe(hgs[index]) for (index, elem) in enumerate(data[algo])] 
...
#plt.ylim(0, 1)
ylabel("Seed set size / Total Edges", fontstyle = "italic", fontsize="20", labelpad=10)
